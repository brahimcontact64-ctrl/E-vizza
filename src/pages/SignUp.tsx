...
export function SignUp() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#F7FAFC] to-[#E6F7F5] flex items-center justify-center px-4 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              ...
              <a href="/signin" className="text-[#00C2A8] font-medium hover:underline">
                {t('signIn')}
              </a>
            </p>
          </div>
